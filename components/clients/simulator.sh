...
# =============================================================
# Client Simulator
# Traffic flow: Client Ã¢â€ â€™ Firewall Ã¢â€ â€™ Squid Ã¢â€ â€™ PEP Ã¢â€ â€™ API Server
# =============================================================
...
while true; do
    if [ "$CLIENT_ROLE" = "legit" ]; then
        # Alice Ã¢â‚¬â€ traffico completamente legittimo
        ...
        # Totem filiale Ã¢â‚¬â€ solo lettura saldi
        ...
        # Bob Ã¢â‚¬â€ dispositivo compromesso
