\contentsline {lstlisting}{\numberline {1}{\ignorespaces Definizione delle quattro reti segregate nel file docker-compose.yaml.}}{9}{lstlisting.1}%
\contentsline {lstlisting}{\numberline {2}{\ignorespaces Definizione delle quattro reti segregate nel file docker-compose.yaml.}}{16}{lstlisting.2}%
\contentsline {lstlisting}{\numberline {3}{\ignorespaces Estratto della configurazione del listener MongoDB in envoy.yaml.}}{18}{lstlisting.3}%
\contentsline {lstlisting}{\numberline {4}{\ignorespaces Configurazione del filtro HTTP Lua in envoy.yaml per la prima linea di difesa L7.}}{19}{lstlisting.4}%
\contentsline {lstlisting}{\numberline {5}{\ignorespaces Struttura della query Splunk MLTK generata dinamicamente da OPA.}}{21}{lstlisting.5}%
\contentsline {lstlisting}{\numberline {6}{\ignorespaces Regole di ispezione profonda L7 DPI per confidenzialità e integrità in rules.rego.}}{22}{lstlisting.6}%
\contentsline {lstlisting}{\numberline {7}{\ignorespaces Regole di autorizzazione adattiva (Score-based) e short-circuiting (Criteria-based) in rules.rego.}}{23}{lstlisting.7}%
\contentsline {lstlisting}{\numberline {8}{\ignorespaces Configurazione delle catene di filtering e NAT nello script di avvio del firewall.}}{24}{lstlisting.8}%
